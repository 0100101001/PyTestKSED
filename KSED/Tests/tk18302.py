...
class KSEDsoftDesAfterRejectInnerSogl_RD(MPages, dataTest, KSEDLocators):
    ...
    def Creat(self,):
        ...
        self.titleCS.send_keys(u'Auto РД 18302 ' + dt)
    ...
    @allure.step("Принятие решения по внутреннему согласованию(Отклонено)")
